import { PointIcon, ShareIcon } from "../Icons/ShareIcon";
import { Tag } from "../Tag/Tag";

export const WorkCardTwo = () => {
  return (
    <div className="w-full h-auto lg:flex">
      <div className="w-full h-auto flex flex-col bg-[#FFFFFF] gap-[24px] p-[48px] rounded-l-xl">
        <div>
      ...
      <div className="w-full h-auto flex justify-center items-center p-[48px] bg-[#F9FAFB] rounded-r-xl">
        <img src="MentorHub.png" alt="" />
      </div>
    </div>
  );
};
